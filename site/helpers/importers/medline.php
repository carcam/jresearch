...
/**
* Imports sets of bibliographical references in MEDLINE format. 
* 
*/
class JResearchMedlineImporter extends JResearchPublicationImporter{
	
	/**
	 * Parse the text sent as parameter in XML MEDLINE format and converts it into 
	...
	function parse($text){
		...
		$conversionCommand = JPATH_SITE.DS.'components'.DS.'com_jresearch'.DS.'bibutils'.DS.$folder.DS.'med2xml'.' '.$filename;
