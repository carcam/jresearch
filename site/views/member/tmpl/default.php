...
<?php if(!empty($this->member->url_personal_page)):  ?>  	
	<div><strong><?php echo JText::_('JRESEARCH_PERSONAL_PAGE').': ';  ?></strong><?php echo JHTML::_('link', str_replace('&', '&amp;', $this->member->url_personal_page), $this->member->url_personal_page); ?></div>
<?php endif; ?>  
<div>&nbsp;</div>
