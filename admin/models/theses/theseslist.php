...
class JResearchModelThesesList extends JResearchModelList{
	...
	*/
	private function _buildQueryOrderBy(){
            ...
            $filter_order = $mainframe->getUserStateFromRequest('thesesfilter_order'.$Itemid, 'filter_order', 'title');
            $filter_order_Dir = strtoupper($mainframe->getUserStateFromRequest('thesesfilter_order_Dir'.$Itemid, 'filter_order_Dir', 'ASC'));
