...
<div class="divTR">
	...
	<div class="divTdl"><input name="editor" id="editor" type="text" size="15" maxlength="255" value="<?php echo $this->publication?$this->publication->editor:'' ?>" />&nbsp;&nbsp;<?php echo JHTML::_('tooltip', JText::_('JRESEARCH_SEPARATED_BY_COMMAS'))?></div>
	<div class="divEspacio" ></div>		
</div>
<div class="divTR">
	<div class="divTd"><label for="volume"><?php echo JText::_('JRESEARCH_VOLUME').': ' ?></label></div>
	<div class="divTdl divTdl2"><input name="volume" id="volume" type="text" size="15" maxlength="30" value="<?php echo $this->publication?$this->publication->volume:'' ?>" /></div>
	<div class="divTd"><label for="number"><?php echo JText::_('JRESEARCH_NUMBER').': ' ?></label></div>
	<div class="divTdl"><input name="number" id="number" type="text" size="15" maxlength="20" value="<?php echo $this->publication?$this->publication->number:'' ?>" /></div>
	<div class="divEspacio" ></div>	
</div>
<div class="divTR">
...
<div class="divTR">
	...
	<div class="divTdl divTdl2"><input name="edition" id="edition" type="text" size="15" maxlength="10" value="<?php echo $this->publication?$this->publication->edition:'' ?>" /></div>
