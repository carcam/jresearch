...
<div class="divTR">
	...
	<div class="divTdl"><input name="institution" id="institution" type="text" size="15" maxlength="255" value="<?php echo $this->publication?$this->publication->institution:'' ?>" /></div>
</div>