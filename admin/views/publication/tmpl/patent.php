...
<div class="divTR">
	...
	<?php $issueDate = isset($this->publication)?$this->publication->issue_date:''; ?>
	<div class="divTdl">
...
<div class="divTR">
	...
	<div class="divTdl divTdl2">
		<input name="address" id="address" type="text" size="15" maxlength="255" value="<?= isset($this->publication)?$this->publication->address:''; ?>" />
	</div>
	<div class="divTd"><label for="office"><?php echo JText::_('JRESEARCH_PATENT_OFFICE').': ' ?></label></div>
	<div class="divTdl">
		<input name="office" id="office" type="text" size="15" maxlength="255" value="<?= isset($this->publication)?$this->publication->office:''; ?>" />
	</div>
	<div class="divEspacio" ></div>
</div>
<div class="divTR">
	...
	<div class="divTdl">
		<textarea cols="50" rows="4" name="claims" id="claims"><?php echo isset($this->publication)?$this->publication->claims:''?></textarea>
	</div>
</div>
