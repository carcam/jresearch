...
<tr>
	<th><?php echo JText::_('JRESEARCH_PATENT_NUMBER').': ' ?></th>		
...
<tr>
	<th><?php echo JText::_('JRESEARCH_FILING_DATE').': ' ?></th>
	...
	<th><?php echo JText::_('JRESEARCH_ISSUE_DATE').': ' ?></th>
