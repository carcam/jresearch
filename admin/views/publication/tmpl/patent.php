...
<div class="divTR">
	...
	<div class="divTdl divTdl2">
		<?php echo JHTML::_('calendar', $filDate ,'filing_date', 'filing_date', '%d-%m-%Y', array('class'=>'validate-date',  'size'=>'10')); ?><br />
	...
	<div class="divTdl">
		<?php echo JHTML::_('calendar', $issueDate ,'issue_date', 'issue_date', '%d-%m-%Y', array('class'=>'validate-date', 'size'=>'10')); ?><br />
