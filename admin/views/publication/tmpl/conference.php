...
<div class="divTR">
	...
	<div class="divTdl divTdl2"><input name="booktitle" id="booktitle" type="text" size="15" maxlength="255" value="<?php echo $this->publication?$this->publication->booktitle:'' ?>" /></div>
...
<div class="divTR">
	...
	<div class="divTdl divTdl2"><input type="text" name="address" id="address" size="15" maxlength="255" value="<?php echo $this->publication?$this->publication->address:'' ?>" /></div>
...
<div class="divTR">
	...
	<div class="divTdl"><input name="organization" id="organization" type="text" size="15" maxlength="255" value="<?php echo $this->publication?$this->publication->organization:'' ?>" /></div>
	<div class="divEspacio" ></div>	
</div>
<div class="divTR">
