...
<div class="divTR">
	...
	<div class="divTdl divTdl2"><input name="key" id="key" type="text" size="12" maxlength="255" value="<?php echo $this->publication?$this->publication->key:'' ?>" /><?php echo JHTML::_('tooltip', JText::_('JRESEARCH_KEY_TOOLTIP'));  ?></div>
