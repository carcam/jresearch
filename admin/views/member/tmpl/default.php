...
<div class="divTable">
	<div class="divTR">
		...
		<div class="divTdl divTdl2">
			<input name="firstname" id="firstname" size="15" maxlength="30" class="required" value="<?php echo $this->member?$this->member->firstname:'' ?>" />
		...
		<div class="divTdl">
			<input name="lastname" id="lastname" size="15" maxlength="30" class="required" value="<?php echo $this->member?$this->member->lastname:''; ?>" />
	...
	<div class="divTR">
		...
		<div class="divTdl"><input type="checkbox" name="former_member" value="1" <?php echo (($this->member->former_member == 1) ? 'checked="checked"' : "")?> /></div>
	    <div class="divEspacio" ></div>		
	</div>	
	<div class="divTR">
		...
		<div class="divTdl"><input type="text" size="15" name="location" id="location" value="<?php echo $this->member?$this->member->location:'' ?>" /></div>
	    <div class="divEspacio" ></div>		
	</div>		
	<div class="divTR">
		<div class="divTd"><label for="phone_or_fax"><?php echo JText::_('JRESEARCH_PHONE_OR_FAX').': ' ?></label></div>
		<div class="divTdl divTdl2"><input name="phone_or_fax" id="phone_or_fax" size="15" maxlength="15" value="<?php echo $this->member?$this->member->phone_or_fax:'' ?>" /></div>
		<div class="divTd"><label for="email"><?php echo JText::_('Email').': ' ?></label></div>
		<div class="divTdl">
			<input maxlength="255" size="15" name="email" class="required validate-email" id="email" value="<?php echo $this->member?$this->member->email:''; ?>" />
	...
	<div class="divTR">
		...
		<div class="divTdl divTdl2">
			<input type="text" size="15" maxlength="255" class="validate-url" name="url_personal_page" id="url_personal_page" value="<?php echo $this->member?$this->member->url_personal_page:'' ?>" />
	...
	<div class="divTR">
		...
		<div class="divEspacio" ></div>	
		<?php echo $this->editor->display( 'description',  $this->member?$this->member->description:'' , '100%', '350', '75', '20' ) ; ?>
	</div>			
</div>
</fieldset>
