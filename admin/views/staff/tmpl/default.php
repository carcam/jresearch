...
<form name="adminForm" method="post" id="adminForm" action="index.php?option=com_jresearch">
	...
	<table class="adminlist" cellspacing="1">
		...
		<tr>		
			...
			<th class="title" width="40%"><?php echo JHTML::_('grid.sort',  'Name', 'lastname', @$lists['order_Dir'], @$lists['order'] ); ?></th>
			...
			<th align="center"><?php echo JText::_('JRESEARCH_RESEARCH_AREA'); ?></th>
		...
		?>
				...
				<tr class="<?php echo "row$k"; ?>">
					...
					<td align="center"><a href="maito:<?php echo $this->items[$i]->email; ?>"><?php echo $this->items[$i]->email ?></td>
				</tr>
			<?php } ?>
		</tbody>
	</table>
