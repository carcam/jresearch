...
class JResearchAdminPublicationsController extends JControllerLegacy
{
    ...
    */ 
    function publish(){		
        ...
        if(!$model->publish()){
            JError::raiseWarning(1, JText::_('JRESEARCH_PUBLISHED_FAILED').': '.implode('<br />', 
                    $model->getErrors()));   
            $this->setRedirect('index.php?option=com_jresearch&controller=publications');       
        }else{
            $this->setRedirect('index.php?option=com_jresearch&controller=publications', 
                    JText::_('JRESEARCH_ITEMS_PUBLISHED_SUCCESSFULLY'));        	
        }
    }
    ...
    */ 
    function unpublish(){
        ...
        if(!$model->unpublish()){
            ...
            $this->setRedirect('index.php?option=com_jresearch&controller=publications', 
                    JText::_('JRESEARCH_ITEMS_UNPUBLISHED_SUCCESSFULLY'));    	
        }
    }
    ...
    */ 
    function remove(){
        ...
        $n = $model->delete();
        $this->setRedirect('index.php?option=com_jresearch&controller=publications', 
                JText::plural('JRESEARCH_N_ITEMS_SUCCESSFULLY_DELETED', $n));
    ...
    */	
    ...
    function toggle_internal(){
        ...
        if($model->toggleInternal())
            $this->setRedirect('index.php?option=com_jresearch&controller=publications', 
                    JText::sprintf('JRESEARCH_TOGGLE_INTERNAL_SUCCESSFULLY'));		
        else
            $this->setRedirect('index.php?option=com_jresearch&controller=publications', 
