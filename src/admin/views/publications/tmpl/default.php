	...
	<table class="table table-striped" cellspacing="1">
            <thead>
                <tr>		
                        ...
                        <th class="nowrap center" style="min-width: 55px;"><?php echo JHTML::_('grid.sort',   JText::_('Published'), 'published', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
                        <th class="nowrap center" style="min-width: 55px;"><?php echo JHTML::_('grid.sort',   JText::_('Internal'), 'internal', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
                        <th class="nowrap center" style="width: 15%;"><?php echo JText::_('JRESEARCH_AUTHORS'); ?></th>
                        <th class="nowrap center" style="width: 15%;"><?php echo JText::_('JRESEARCH_RESEARCH_AREAS'); ?></th>                        
                        <th class="nowrap center" style="width: 5%;"><?php echo JHTML::_('grid.sort',   JText::_('JRESEARCH_YEAR'), 'year', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
                        <th class="nowrap center" style="width: 10%;"><?php echo JHTML::_('grid.sort',   JText::_('JRESEARCH_CITEKEY'), 'citekey', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
                        <th class="nowrap center" style="width: 5%;"><?php echo JHTML::_('grid.sort',   JText::_('JRESEARCH_TYPE'), 'pubtype', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
                        <th class="nowrap center" style="width: 5%;"><?php echo JText::_('Hits'); ?></th>
                        <th class="nowrap center" style="width: 10%;"><?php echo JText::_('JRESEARCH_EXPORT'); ?></th>
                </tr>
            </thead>
            <tfoot>
                <tr>
            ...
            <tbody>
                    ...
                    for ($i=0; $i<$n; $i++) :
                            ...
                            $authorsText = JResearchPublicationsHelper::formatAuthorsArray($authors, $this->params->get('staff_format', 'last_first'));
                            // Links for exporting
                            $exportLinks = array();
