...
<h3><?php echo JText::_('JRESEARCH_'.strtoupper($this->pubtype).'_DEFINITION'); ?></h3>
...
<tbody>
	...
	<tr>
		...
		<td colspan="4"><textarea name="abstract" id="abstract" cols="60" rows="5" ><?php echo $this->publication?$this->publication->abstract:'' ?></textarea></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			<input type="hidden" name="internal" id="internal" value="1" />
	...
	<tr>
		...
		<td>
			<input value="<?php echo $this->publication?$this->publication->impact_factor:'' ?>" size="10" name="impact_factor" id="impact_factor" maxlength="5" class="validate-numeric" />
			<br />
