...
<form name="adminForm" method="post" id="adminForm" action="index.php?option=com_jresearch">
	<div>
		<?php echo !empty($this->lists['search'])?'<span style="float:left;">'.$this->lists['search'].'</span>':''; ?>
		<?php echo !empty($this->lists['teams'])?'<span style="float:left;">'.$this->lists['teams'].'</span>':''; ?>	
	...
	<table>
		...
		?>
				...
				<tr class="<?php echo "row$i"; ?>">
					...
					<?php else: ?>
						<td width="10%" align="center"><?php echo $this->items[$i]->getImpactFactor()?$this->items[$i]->getImpactFactor():'--'; ?></td>					
					<?php endif; ?>	
