<div class="componentheading" style="float: left;">
	<?php echo JText::_('JRESEARCH_'.JString::strtoupper(JRequest::getVar('task')).'_PROJECT');?>
</div>
<?php 
if((JHTML::_('Jresearch.authorize','edit', 'projects', $this->id) && !empty($this->id)) || (JHTML::_('Jresearch.authorize','add', 'projects') && (empty($this->id)))):
?>
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<label for="delete" /><?php echo JText::_('JRESEARCH_DELETE_CURRENT_LOGO'); ?></label><input type="checkbox" name="delete" id="delete" />
			</td>		
		</tr>
		<tr>
