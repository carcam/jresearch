...
function setACL()
{
	...
	//Export publications
	$acl->addACL('com_jresearch', 'export', 'users', 'registered', 'publications', 'own');
	$acl->addACL('com_jresearch', 'export', 'users', 'author', 'publications', 'own');
	$acl->addACL('com_jresearch', 'export', 'users', 'editor', 'publications', 'all');
	$acl->addACL('com_jresearch', 'export', 'users', 'publisher', 'publications', 'all');
	$acl->addACL('com_jresearch', 'export', 'users', 'manager', 'publications', 'all');
	...
	$acl->addACL('com_jresearch', 'export', 'users', 'editor', 'projects', 'all');
	$acl->addACL('com_jresearch', 'export', 'users', 'publisher', 'projects', 'all');
	$acl->addACL('com_jresearch', 'export', 'users', 'manager', 'projects', 'all');
	$acl->addACL('com_jresearch', 'export', 'users', 'administrator', 'projects', 'all');
	$acl->addACL('com_jresearch', 'export', 'users', 'super administrator', 'projects', 'all');
