...
* @subpackage	Courses
*/
class JResearchAdminCoursesController extends JController
{
	/**
	...
	function __construct()
	{
		...
		$lang->load('com_jresearch.courses');
		...
		$this->addModelPath(JPATH_COMPONENT_ADMINISTRATOR.DS.'models'.DS.'courses');
		$this->addViewPath(JPATH_COMPONENT_ADMINISTRATOR.DS.'views'.DS.'courses');
	}
