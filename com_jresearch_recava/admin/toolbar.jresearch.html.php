...
/**
	...
	*/	
	...
	public static function journalsAdminListToolbar()
	{
		JToolBarHelper::title(JText::_('JRESEARCH_JOURNALS'));
	...
	public static function editJournalAdminToolbar()
	{
		$cid = JRequest::getVar('cid');
		if($cid)
			$title = JText::_('JRESEARCH_EDIT_JOURNAL');
		else
			$title = JText::_('JRESEARCH_NEW_JOURNAL');	
