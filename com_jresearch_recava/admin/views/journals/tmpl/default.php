...
<form name="adminForm" method="post" id="adminForm" action="index.php?option=com_jresearch">
	...
	<table class="adminlist" cellspacing="1">
		...
		<tr>		
			...
			<th width="10%"><?php echo JText::_('JRESEARCH_IMPACT_FACTOR'); ?></th>
		</tr>
		</thead>
		...
		?>
				...
				<tr class="<?php echo "row$k"; ?>">
					...
					<td width="30%"><a href="<?php echo JFilterOutput::ampReplace('index.php?option=com_jresearch&controller=journals&task=edit&cid[]='.$this->items[$i]->id); ?>"><?php echo $this->items[$i]->title;  ?></a></td>
					<td align="center"><?php echo $published; ?></td>
					<td align="center"><?php echo $this->items[$i]->impact_factor; ?></td>
				</tr>
			<?php } ?>
		</tbody>
	</table>
